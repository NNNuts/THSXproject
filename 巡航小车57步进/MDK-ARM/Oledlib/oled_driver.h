...
#include "oled_basic.h"
	...
	#define OLED_ADDRESS  0x78 	//通过调整0R电阻,屏可以0x78和0x7A两个地址 -- 默认0x78
	#define IIC_SCL             BIT_ADDR(GPIOB_ODR_Addr, 7) 	//SCL
	#define IIC_SDA             BIT_ADDR(GPIOB_ODR_Addr, 6) 	//SDA
    ...
    #define IIC_SCL_1           HAL_GPIO_WritePin(OLED_SCL_GPIO_Port, OLED_SCL_Pin, GPIO_PIN_SET)
    #define IIC_SCL_0           HAL_GPIO_WritePin(OLED_SCL_GPIO_Port, OLED_SCL_Pin, GPIO_PIN_RESET)
    #define IIC_SDA_1           HAL_GPIO_WritePin(OLED_SDA_GPIO_Port, OLED_SDA_Pin, GPIO_PIN_SET)
